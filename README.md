# PrestaShop 9 WhiteLabelName Integration
...
To install module manually by dragging up zip file, please download [.zip archive](https://whitelabel-docs.com/prestashop/2.0.7/whitelabelmachinename.zip) of module with correct structure required by Prestashop installation
...
* [English](https://whitelabel-docs.com/prestashop/2.0.7/docs/en/documentation.html)
...
Please see the [license file](https://github.com/WhiteLabelGithubOwnerName/prestashop/blob/2.0.7/LICENSE) for more information.
