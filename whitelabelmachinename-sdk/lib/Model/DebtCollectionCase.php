...
class DebtCollectionCase implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Address $billing_address The billing address that identifies the debtor.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DebtCollectorConfiguration $collector_configuration The configuration that the case is processed with.
     *
     * @return $this
     */
     ...
     * Sets environment
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DebtCollectionEnvironment $environment The environment in which the case is processed.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WhiteLabelMachineName\Sdk\Model\FailureReason $failure_reason The reason for the failure of the case.
     *
     * @return $this
     */
     ...
     * Sets labels
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Label[] $labels The labels providing additional information about the object.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WhiteLabelMachineName\Sdk\Model\LineItem[] $line_items The line items that are subject of this debt collection case.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DebtCollectionCaseSource $source The source of the case stating the origin of the claim.
     *
     * @return $this
     */
