...
class SubscriptionSuspension implements ModelInterface, ArrayAccess
{
     ...
     * Sets end_action
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionSuspensionAction $end_action Whether the subscription should be terminated or reactivated after the suspension has reached its end date.
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionSuspensionReason $reason The reason why the subscription was suspended.
     *
     * @return $this
     */
