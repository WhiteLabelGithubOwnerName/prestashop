...
class SubscriberUpdate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\AddressCreate $billing_address The address associated with the subscriber for invoicing and transaction processing purposes.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\AddressCreate $shipping_address The address to where orders will be shipped.
     *
     * @return $this
     */
