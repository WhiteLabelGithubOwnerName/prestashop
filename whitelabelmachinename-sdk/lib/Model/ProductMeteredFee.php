...
class ProductMeteredFee implements ModelInterface, ArrayAccess
{
     ...
     * Sets metric
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionMetric $metric The metric used to determine the resource consumption billed to the customer.
     *
     * @return $this
     */
     ...
     * Sets tier_pricing
     *
     * @param \WhiteLabelMachineName\Sdk\Model\ProductMeteredTierPricing $tier_pricing The method used to calculate the tier price.
     *
     * @return $this
     */
