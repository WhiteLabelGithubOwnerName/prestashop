...
class SubscriptionLedgerEntry implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'external_id' => 'string',
        'fee_type' => '\WhiteLabelMachineName\Sdk\Model\ProductFeeType',
        'id' => 'int',
        'linked_space_id' => 'int',
     ...
     * Sets fee_type
     *
     * @param \WhiteLabelMachineName\Sdk\Model\ProductFeeType $fee_type 
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Tax[] $taxes A set of tax lines, each of which specifies a tax applied to the ledger entry.
     *
     * @return $this
     */
