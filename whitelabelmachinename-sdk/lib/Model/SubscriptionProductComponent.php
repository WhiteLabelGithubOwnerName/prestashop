...
class SubscriptionProductComponent implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionProductComponentGroup $component_group The group that the component belongs to.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionProductComponentReference $reference The reference is used to link components across different product versions.
     *
     * @return $this
     */
     ...
     * Sets tax_class
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TaxClass $tax_class The tax class to be applied to fees.
     *
     * @return $this
     */
