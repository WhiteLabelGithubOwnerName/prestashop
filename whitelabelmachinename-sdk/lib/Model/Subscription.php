...
class Subscription implements ModelInterface, ArrayAccess
{
     ...
     * Sets affiliate
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionAffiliate $affiliate The affiliate that led to the creation of the subscription.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionProductVersion $current_product_version The version of the product that the subscription is currently linked to.
     *
     * @return $this
     */
     ...
     * Sets subscriber
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Subscriber $subscriber The subscriber that the subscription belongs to.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Token $token The payment token that is used to charge the customer.
     *
     * @return $this
     */
