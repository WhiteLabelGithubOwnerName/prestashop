...
class ProductSetupFeeUpdate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_downgrade_credited_amount The amount charged to the customer when a subscription is downgraded.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PersistableCurrencyAmountUpdate[] $on_upgrade_credited_amount The amount charged to the customer when a subscription is upgraded.
     *
     * @return $this
     */
     ...
     * Sets setup_fee
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PersistableCurrencyAmountUpdate[] $setup_fee The amount charged to the customer once when they subscribe to a subscription.
     *
     * @return $this
     */
