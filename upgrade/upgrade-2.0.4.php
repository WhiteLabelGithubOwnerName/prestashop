...
{
	try {
		require_once _PS_MODULE_DIR_ . 'whitelabelmachinename/inc/Webhooksignature.php';

		$moduleInstance = $module;
		if (!($moduleInstance instanceof WhiteLabelMachineName) || !$moduleInstance->id) {
			$moduleInstance = \Module::getInstanceByName('whitelabelmachinename');
		}

		if ($moduleInstance && !$moduleInstance->id) {
			$moduleInstance->id = (int) \Module::getModuleIdByName('whitelabelmachinename');
		}
